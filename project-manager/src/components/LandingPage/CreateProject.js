                            ...
                            <div>
                                ...
                                <div>
                                    <div className="username-entry">
                                        <label htmlFor="" className="username-label">Description</label>
                                    </div>
                                ...
                                <div>
                                    <div className="username-entry">
                                        <label htmlFor="" className="username-label">Status</label>
                                    </div>
                                    <div className="placeholder-username">
                                        <select 
                                        type="text" 
                                ...
                                <div>
                                    ...
                                    <div className="password-entry">
                                        <label htmlFor="" className="password-label"> Proceed</label>
                                    </div>
